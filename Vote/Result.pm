package Tags::HTML::Commons::Vote::Result;
...
Tags::HTML::Commons::Vote::Result - Tags helper for image voting.

=head1 SYNOPSIS

 use Tags::HTML::Commons::Vote::Result;

 my $obj = Tags::HTML::Commons::Vote::Result->new(%params);
 $obj->process(@images);
